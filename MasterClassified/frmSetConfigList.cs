    ...
    public partial class frmSetConfigList : Form
    {
        ...
        private void InitialSystemInfo()
        {
            try
            {
                ...
                List<FangAnLieBiaoDATA> Result = BusinessHelp.Read_Piliang_FangAnName();
                List<FangAnLieBiaoDATA> filtered = Result.FindAll(s => s.Name != null);
                this.listBox1.DataSource = filtered;
                List<FangAnLieBiaoDATA> Result12 = BusinessHelp.Read_Piliang_AllFangAn();
                Result_new = Result12;
                ...
                List<FangAnLieBiaoDATA> moreResult = BusinessHelp.Read_Piliang_FangAn(this.listBox1.Text.ToString());
                ...
                if (moreResult.Count > 0 && moreResult[0].MorenDuanShu != null && moreResult[0].MorenDuanShu != "")
                    this.comboBox1.Text = moreResult[0].MorenDuanShu;
                else
                    if (Result.Count > 0)
                        this.comboBox1.SelectedIndex = 0;

                if (moreResult.Count > 0 && moreResult[0].Mobanleibie != null && moreResult[0].Mobanleibie != "")
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            for (int j = 0; j < Result_new.Count; j++)
            {
                FangAnLieBiaoDATA item = new FangAnLieBiaoDATA();

                string[] temp11 = System.Text.RegularExpressions.Regex.Split(Result_new[j].Data, "\r\n");
                List<string> showSuijiResultlist1 = new List<string>();

                for (int i1 = 1; i1 < temp11.Length; i1++)
                {
                    showSuijiResultlist1.Add(temp11[i1]);
                }
                for (int i = 0; i < showSuijiResultlist1.Count; i++)
                {
                    string[] temp1 = System.Text.RegularExpressions.Regex.Split(showSuijiResultlist1[i], "=");
                    if (i == 0)
                ...
                item.Name = Result_new[j].Name.ToString();//保存名称
                item.DuanShu = showSuijiResultlist1.Count.ToString();
                Result.Add(item);
            }
        ...
        private void listBox1_DoubleClick(object sender, EventArgs e)
        {
            ...
            List<FangAnLieBiaoDATA> Result = Result_new.FindAll(s => s.Name != null && s.Name == this.listBox1.Text.ToString());
            showSuijiResultlist = new List<string>();
        ...
        private void 增加ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                frmAddFanAnName = new frmAddFanAnName("",1);
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            clsAllnew BusinessHelp = new clsAllnew();
            BusinessHelp.delete_PiLiang_FangAn(this.listBox1.Text);
        ...
        private void 改名ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (frmAddFanAnName == null)
            {
                frmAddFanAnName = new frmAddFanAnName(this.listBox1.Text,1);
                frmAddFanAnName.FormClosed += new FormClosedEventHandler(FrmOMS_FormClosed);
            }
            if (frmAddFanAnName == null)
            {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            this.listBox1.DisplayMember = "Name";
            this.listBox1.DataSource = Result_new;

        }

        private void get_tx1(List<FangAnLieBiaoDATA> Result)
        {
            FangAnLieBiaoDATA item = new FangAnLieBiaoDATA();
            ...
            ;
            int fanganindex = 0;
            fanganindex = Result_new.Count + 1;

            item.Name = "方案 " + fanganindex;//保存名称
            item.DuanShu = showSuijiResultlist.Count.ToString();
            Result.Add(item);
        }
        ...
        private void 改名ToolStripMenuItem1_Click(object sender, EventArgs e)
        {

            改名ToolStripMenuItem_Click(this, EventArgs.Empty);
        }

        private void 增加ToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            增加ToolStripMenuItem_Click(this, EventArgs.Empty);
        }
    }
}
